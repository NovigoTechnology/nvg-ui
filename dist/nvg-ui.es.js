import { ref as Nt, readonly as Ge, getCurrentInstance as Wt, onMounted as Ye, nextTick as Ze, watch as qe, useId as Xe, mergeProps as L, openBlock as G, createElementBlock as xt, createElementVNode as ge, renderSlot as ut, createTextVNode as Je, toDisplayString as me, resolveComponent as Ft, resolveDirective as Qe, withDirectives as tn, createBlock as Ct, resolveDynamicComponent as en, withCtx as nn, createCommentVNode as Ht, normalizeClass as Gt, unref as on } from "vue";
function ct(...t) {
  if (t) {
    let e = [];
...
function zt(t, e = "", n = {}) {
  const o = B(e).split("."), r = o.shift();
  if (r) {
    if (Z(t)) {
      const a = Object.keys(t).find((l) => B(l) === r) || "";
...
var $n = Object.defineProperty, _n = Object.defineProperties, Sn = Object.getOwnPropertyDescriptors, jt = Object.getOwnPropertySymbols, ye = Object.prototype.hasOwnProperty, $e = Object.prototype.propertyIsEnumerable, Jt = (t, e, n) => e in t ? $n(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n }) : t[e] = n, V = (t, e) => {
  for (var n in e || (e = {}))
...
var bt = (...t) => xn(O.getTheme(), ...t), xn = (t = {}, e, n, o) => {
  if (e) {
...
function Tn(t, e = {}) {
  const n = O.defaults.variable, { prefix: o = n.prefix, selector: r = n.selector, excludedKeyRegex: a = n.excludedKeyRegex } = e, l = (u, d = "") => Object.entries(u).reduce(
    (c, [p, b]) => {
      const g = M(p, a) ? Vt(d) : Vt(d, ve(p)), y = wn(b);
      if (Z(y)) {
        const { variables: h, tokens: _ } = l(y, g);
        Qt(c.tokens, _), Qt(c.variables, h);
      } else
        c.tokens.push((o ? g.replace(`${o}-`, "") : g).replaceAll("-", ".")), Cn(c.variables, _e(g), Se(y, g, o, [a]));
      return c;
    },
    { variables: [], tokens: [] }
...
var I = {
  ...
  getCommon({ name: t = "", theme: e = {}, params: n, set: o, defaults: r }) {
    ...
    if (P(p) && b.transform !== "strict") {
      const { primitive: v, semantic: x, extend: A } = p, K = x || {}, { colorScheme: W } = K, q = U(K, ["colorScheme"]), F = A || {}, { colorScheme: X } = F, J = U(F, ["colorScheme"]), H = W || {}, { dark: Q } = H, ot = U(H, ["dark"]), tt = X || {}, { dark: rt } = tt, it = U(tt, ["dark"]), z = P(v) ? this._toVariables({ primitive: v }, b) : {}, D = P(q) ? this._toVariables({ semantic: q }, b) : {}, et = P(ot) ? this._toVariables({ light: ot }, b) : {}, wt = P(Q) ? this._toVariables({ dark: Q }, b) : {}, at = P(J) ? this._toVariables({ semantic: J }, b) : {}, Mt = P(it) ? this._toVariables({ light: it }, b) : {}, Kt = P(rt) ? this._toVariables({ dark: rt }, b) : {}, [Te, je] = [(a = z.declarations) != null ? a : "", z.tokens], [Le, Ne] = [(l = D.declarations) != null ? l : "", D.tokens || []], [Ae, Ee] = [(s = et.declarations) != null ? s : "", et.tokens || []], [Ie, Ve] = [(i = wt.declarations) != null ? i : "", wt.tokens || []], [De, Re] = [(u = at.declarations) != null ? u : "", at.tokens || []], [Be, ze] = [(d = Mt.declarations) != null ? d : "", Mt.tokens || []], [Ue, Me] = [(c = Kt.declarations) != null ? c : "", Kt.tokens || []];
      g = this.transformCSS(t, Te, "light", "variable", b, o, r), y = je;
      const Ke = this.transformCSS(t, `${Le}${Ae}`, "light", "variable", b, o, r), We = this.transformCSS(t, `${Ie}`, "dark", "variable", b, o, r);
      h = `${Ke}${We}`, _ = [.../* @__PURE__ */ new Set([...Ne, ...Ee, ...Ve])];
      const Fe = this.transformCSS(t, `${De}${Be}color-scheme:light`, "light", "variable", b, o, r), He = this.transformCSS(t, `${Ue}color-scheme:dark`, "dark", "variable", b, o, r);
      k = `${Fe}${He}`, w = [.../* @__PURE__ */ new Set([...Re, ...ze, ...Me])], f = E(p.css, { dt: bt });
    }
    return {
      primitive: {
        css: g,
  ...
  getPreset({ name: t = "", preset: e = {}, options: n, params: o, set: r, defaults: a, selector: l }) {
    ...
    if (P(e) && n.transform !== "strict") {
      const b = t.replace("-directive", ""), g = e, { colorScheme: y, extend: h, css: _ } = g, k = U(g, ["colorScheme", "extend", "css"]), w = h || {}, { colorScheme: f } = w, v = U(w, ["colorScheme"]), x = y || {}, { dark: A } = x, K = U(x, ["dark"]), W = f || {}, { dark: q } = W, F = U(W, ["dark"]), X = P(k) ? this._toVariables({ [b]: V(V({}, k), v) }, n) : {}, J = P(K) ? this._toVariables({ [b]: V(V({}, K), F) }, n) : {}, H = P(A) ? this._toVariables({ [b]: V(V({}, A), q) }, n) : {}, [Q, ot] = [(s = X.declarations) != null ? s : "", X.tokens || []], [tt, rt] = [(i = J.declarations) != null ? i : "", J.tokens || []], [it, z] = [(u = H.declarations) != null ? u : "", H.tokens || []], D = this.transformCSS(b, `${Q}${tt}`, "light", "variable", n, r, a, l), et = this.transformCSS(b, it, "dark", "variable", n, r, a, l);
  ...
  update(t = {}) {
    const { theme: e } = t;
    e && (this._theme = Et(V({}, e), {
      options: V(V({}, this.defaults.options), e.options)
    }), this._tokens = I.createTokens(this.preset, this.defaults), this.clearLoadedStyleNames());
  },
  get theme() {
    return this._theme;
  },
  ...
  setPreset(t) {
    this._theme = Et(V({}, this.theme), { preset: t }), this._tokens = I.createTokens(t, this.defaults), this.clearLoadedStyleNames(), T.emit("preset:change", t), T.emit("theme:change", this.theme);
  },
  getOptions() {
    return this.options;
  },
  setOptions(t) {
    this._theme = Et(V({}, this.theme), { options: t }), this.clearLoadedStyleNames(), T.emit("options:change", t), T.emit("theme:change", this.theme);
  },
  getLayerNames() {
  ...
  getTokenValue(t) {
    return I.getTokenValue(this.tokens, t, this.defaults);
  },
  getCommon(t = "", e) {
    return I.getCommon({ name: t, theme: this.theme, params: e, defaults: this.defaults, set: { layerNames: this.setLayerNames.bind(this) } });
  },
  getComponent(t = "", e) {
    const n = { name: t, theme: this.theme, params: e, defaults: this.defaults, set: { layerNames: this.setLayerNames.bind(this) } };
    return I.getPresetC(n);
  },
  // @deprecated - use getComponent instead
  getDirective(t = "", e) {
    const n = { name: t, theme: this.theme, params: e, defaults: this.defaults, set: { layerNames: this.setLayerNames.bind(this) } };
    return I.getPresetD(n);
  },
  getCustomPreset(t = "", e, n, o) {
    ...
    return I.getPreset(r);
  },
  getLayerOrderCSS(t = "") {
    return I.getLayerOrder(t, this.options, { names: this.getLayerNames() }, this.defaults);
  },
  transformCSS(t = "", e, n = "style", o) {
    return I.transformCSS(t, e, o, n, this.options, { layerNames: this.setLayerNames.bind(this) }, this.defaults);
  },
  getCommonStyleSheet(t = "", e, n = {}) {
    return I.getCommonStyleSheet({ name: t, theme: this.theme, params: e, props: n, defaults: this.defaults, set: { layerNames: this.setLayerNames.bind(this) } });
  },
  getStyleSheet(t, e, n = {}) {
    return I.getStyleSheet({ name: t, theme: this.theme, params: e, props: n, defaults: this.defaults, set: { layerNames: this.setLayerNames.bind(this) } });
  },
  onStyleMounted(t) {
  ...
  var e = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, n = Nt(!1), o = Nt(t), r = Nt(null), a = gn() ? window.document : void 0, l = e.document, s = l === void 0 ? a : l, i = e.immediate, u = i === void 0 ? !0 : i, d = e.manual, c = d === void 0 ? !1 : d, p = e.name, b = p === void 0 ? "style_".concat(++In) : p, g = e.id, y = g === void 0 ? void 0 : g, h = e.media, _ = h === void 0 ? void 0 : h, k = e.nonce, w = k === void 0 ? void 0 : k, f = e.first, v = f === void 0 ? !1 : f, x = e.onMounted, A = x === void 0 ? void 0 : x, K = e.onUpdated, W = K === void 0 ? void 0 : K, q = e.onLoad, F = q === void 0 ? void 0 : q, X = e.props, J = X === void 0 ? {} : X, H = function() {
    ...
    if (s) {
      ...
      r.value = s.querySelector('style[data-primevue-style-id="'.concat(D, '"]')) || s.getElementById(et) || s.createElement("style"), r.value.isConnected || (o.value = rt || t, Tt(r.value, {
        ...
        return F == null ? void 0 : F(at, {
          name: D
        });
      }, A == null || A(D)), !n.value && (H = qe(o, function(at) {
    ...
    !s || !n.value || (H(), un(r.value) && s.head.removeChild(r.value), n.value = !1, r.value = null);
  };
  return u && !c && En(Q), {
    id: y,
    name: b,
  ...
  if (n != null) {
    ...
    try {
      if (a = (n = n.call(t)).next, e !== 0)
        for (; !(i = (o = a.call(n)).done) && (s.push(o.value), s.length !== e); i = !0)
          ;
    } catch (d) {
      u = !0, r = d;
    } finally {
      try {
        if (!i && n.return != null && (l = n.return(), Object(l) !== l))
          return;
      } finally {
        if (u)
          throw r;
  ...
  methods: {
    ...
    _mergeProps: function(e) {
      for (var n = arguments.length, o = new Array(n > 1 ? n - 1 : 0), r = 1; r < n; r++)
        o[r - 1] = arguments[r];
      return Bt(e) ? e.apply(void 0, o) : L.apply(void 0, o);
    },
    _load: function() {
      Y.isStyleNameLoaded("base") || (C.loadCSS(this.$styleOptions), this._loadGlobalStyles(), Y.setLoadedStyleName("base")), this._loadThemeStyles();
    },
    ...
    _loadThemeStyles: function() {
      ...
      if (!(this.isUnstyled || this.$theme === "none")) {
        if (!O.isStyleNameLoaded("common")) {
          ...
          }, this.$styleOptions)), C.load(s == null ? void 0 : s.css, $({
            name: "semantic-variables"
          }, this.$styleOptions)), C.load(i == null ? void 0 : i.css, $({
            name: "global-variables"
          }, this.$styleOptions)), C.loadStyle($({
            name: "global-style"
    ...
    _getPTDatasets: function() {
      ...
      return o !== "transition" && $($({}, o === "root" && $($(dt({}, "".concat(r, "name"), B(a ? (n = this.pt) === null || n === void 0 ? void 0 : n["data-pc-section"] : this.$.type.name)), a && dt({}, "".concat(r, "extend"), B(this.$.type.name))), {}, dt({}, "".concat(this.$attrSelector), ""))), {}, dt({}, "".concat(r, "section"), B(o)));
    },
    ...
    _getPT: function(e) {
      var n = this, o = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : "", r = arguments.length > 2 ? arguments[2] : void 0, a = function(s) {
        var i, u = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : !1, d = r ? r(s) : s, c = B(o), p = B(n.$name);
...
var m = {
  ...
  _loadCoreStyles: function() {
    ...
    if (!Y.isStyleNameLoaded((e = o.$style) === null || e === void 0 ? void 0 : e.name) && (n = o.$style) !== null && n !== void 0 && n.name) {
      var a;
      C.loadCSS(r), (a = o.$style) === null || a === void 0 || a.loadCSS(r), Y.setLoadedStyleName(o.$style.name);
    }
  },
  _loadThemeStyles: function() {
    ...
    if (!(r != null && r.isUnstyled() || (r == null || (e = r.theme) === null || e === void 0 ? void 0 : e.call(r)) === "none")) {
      if (!O.isStyleNameLoaded("common")) {
        ...
        C.load(u == null ? void 0 : u.css, S({
          name: "primitive-variables"
        }, a)), C.load(d == null ? void 0 : d.css, S({
          name: "semantic-variables"
        }, a)), C.load(c == null ? void 0 : c.css, S({
          name: "global-variables"
        }, a)), C.loadStyle(S({
          name: "global-style"
      ...
      if (!O.isStyleNameLoaded("layer-order")) {
        var f, v, x = (f = r.$style) === null || f === void 0 || (v = f.getLayerOrderThemeCSS) === null || v === void 0 ? void 0 : v.call(f);
        C.load(x, S({
          name: "layer-order",
          first: !0
  ...
  _extend: function(e) {
    var n = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, o = function(s, i, u, d, c) {
      ...
      i._$instances[e] = S(S({}, _), {}, {
        ...
        /* instance's methods */
        ptm: function() {
          var f, v = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : "", x = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
          return m._getPTValue(i._$instances[e], (f = i._$instances[e]) === null || f === void 0 || (f = f.$binding) === null || f === void 0 || (f = f.value) === null || f === void 0 ? void 0 : f.pt, v, S({}, x));
        },
        ptmo: function() {
          var f = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}, v = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : "", x = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
          return m._getPTValue(i._$instances[e], f, v, x, !1);
        },
        cx: function() {
          var f, v, x = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : "", A = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
          return (f = i._$instances[e]) !== null && f !== void 0 && f.isUnstyled() ? void 0 : m._getOptionValue((v = i._$instances[e]) === null || v === void 0 || (v = v.$style) === null || v === void 0 ? void 0 : v.classes, x, S({}, A));
        },
        sx: function() {
          var f, v = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : "", x = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : !0, A = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
          return x ? m._getOptionValue((f = i._$instances[e]) === null || f === void 0 || (f = f.$style) === null || f === void 0 ? void 0 : f.inlineStyles, v, S({}, A)) : void 0;
        }
...
var Vo = {
  root: function(e) {
    ...
    return ["p-button p-component", R(R(R(R(R(R(R(R(R({
  ...
  icon: function(e) {
    var n = e.props;
    return ["p-button-icon", R({}, "p-button-icon-".concat(n.iconPos), n.label)];
  },
...
function j(t, e, n) {
  return (e = Bo(e)) in t ? Object.defineProperty(t, e, { value: n, enumerable: !0, configurable: !0, writable: !0 }) : t[e] = n, t;
}
function Bo(t) {
  var e = zo(t, "string");
...
function Ko(t, e, n, o, r, a) {
  var l = Ft("SpinnerIcon"), s = Ft("Badge"), i = Qe("ripple");
    ...
    default: nn(function() {
      return [ut(t.$slots, "default", {}, function() {
        return [t.loading ? ut(t.$slots, "loadingicon", L({
          ...
          return [t.loadingIcon ? (G(), xt("span", L({
            key: 0,
            class: [t.cx("loadingIcon"), t.cx("icon"), t.loadingIcon]
          }, t.ptm("loadingIcon")), null, 16)) : (G(), Ct(l, L({
            key: 1,
            class: [t.cx("loadingIcon"), t.cx("icon")],
            spin: ""
          ...
          return [t.icon ? (G(), xt("span", L({
            key: 0,
            class: [t.cx("icon"), t.icon, t.iconClass],
            "data-p": a.dataIconP
          }, t.ptm("icon")), null, 16, Uo)) : Ht("", !0)];
        }), ge("span", L({
          class: t.cx("label")
        }, t.ptm("label"), {
          "data-p": a.dataLabelP
        }), me(t.label || " "), 17, Mo), t.badge ? (G(), Ct(s, {
          key: 2,
          value: t.badge,
          ...
          unstyled: t.unstyled,
          pt: t.ptm("pcBadge")
        }, null, 8, ["value", "class", "severity", "unstyled", "pt"])) : Ht("", !0)];
      })];
    }),
    _: 3
  }, 16, ["class", "data-p"])), [[i]]);
...
const Wo = (t, e) => {
  ...
  setup(t) {
    ...
    return (n, o) => (G(), Ct(on(xe), {
      label: "Click me!",
      onClick: e
    }));
  }
}, Go = /* @__PURE__ */ Wo(Fo, [["__scopeId", "data-v-a10310ea"]]);
export {
  Go as MiComponente
};
